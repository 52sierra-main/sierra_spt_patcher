...
_KO = {
    ...
    "Log file unavailable (this session only)": "로그 파일을 만들 수 없습니다 (이번 실행에만 표시)",
    "No log file could be created for this session.": "이번 실행에서는 로그 파일을 만들지 못했습니다.",
    "There is nothing to save yet.": "아직 저장할 내용이 없습니다.",
    "There is nothing to copy yet.": "아직 복사할 내용이 없습니다.",
    "Could not save the log:\n{error}": "로그를 저장하지 못했습니다:\n{error}",
    "Log saved to:\n{path}": "로그를 저장했습니다:\n{path}",
    "Info": "정보",
    "Progress": "진행 상황",
    "Idle": "대기 중",
    ...
    "Checking your Tarkov copy": "타르코프 복사본 확인 중",
